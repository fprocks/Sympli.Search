...
using Sympli.Search.WebApi.Middlewares;
using Sympli.Search.Usecases.Validators;

namespace Sympli.Search.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ISearchRequestValidator, SearchRequestValidator>();
            services.AddSingleton<ICache, MemoryCacheAdapter>();
            services.AddScoped<IHtmlParser, HtmlParser>();
            services.AddScoped<ISearchEngine, GoogleSearch>();
            services.AddScoped<ISearchEngine, BingSearch>();
